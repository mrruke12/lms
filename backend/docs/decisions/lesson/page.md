# Element
#### Problem
A structure of a page might be complex: containing nesting, different types of elements, various layouts, and etc. Providing support for elements with dynamic styles and content is hard, since we must predefine them all.
#### Solution
...
1. **Element** - an abstract page element, bearing *type* and *config* determining how element will be rendered; also has a reference to parent element if one exist;
